    ...
    class FswebS18ChallengeMavenApplicationTests {
        ...
        void testCardNotFoundException() throws Exception {
            ...
            given(cardRepository.findByColor("HEART")).willThrow(
                    new CardException("Card not found", HttpStatus.NOT_FOUND)
            );

            mockMvc.perform(get("/cards/byColor/{color}", "HEART"))
        ...
        void testGetCardByColor() throws Exception {
            given(cardRepository.findByColor("HEART")).willReturn(List.of(card));
        ...
        void testUpdateCard() throws Exception {
            ...
            updatedCard.setColor(Color.HEART);
